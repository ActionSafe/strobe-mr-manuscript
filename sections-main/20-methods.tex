...
The original STROBE-MR checklist is grouped into 6 sections (Title and Abstract, Introduction, Methods, Results, Discussion and Other Information). These sections include a total of 43 subitems (we use "items" for simplicity in the remainder of this paper). Some items are compound questions that contain requirements for different types of information, for example, item 4(a): \textit{Setting: Describe the study design and the underlying population, if possible. 
