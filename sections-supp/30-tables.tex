...
16 & Methods & 4b & [Participants] For each data source, give the eligibility criteria, and the sources and methods of selection of participants \\
17 & Methods & 4b & [Participants] For each data source, report the sample size \\
18 & Methods & 4b & [Participants] For each data source, report whether any power or sample size calculations were carried out prior to the main analysis \\
19 & Methods & 4c & [Participants] For each data source, describe measurement of genetic variants \\
20 & Methods & 4c & [Participants] For each data source,  describe quality control of genetic variants \\
21 & Methods & 4c & [Participants] For each data source, describe  selection of genetic variants \\
...
\toprule
Index & Section & Item & Yes(JZ) & No(JZ) & Yes(XW) & No(XW) & Disagreement \\
\midrule
\endfirsthead
